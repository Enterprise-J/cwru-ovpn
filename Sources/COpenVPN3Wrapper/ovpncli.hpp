...
// and TunBuilderBase.
//
// This vendored copy intentionally stays close to upstream. Keep local changes
// limited to clear correctness or measurable integration wins.
